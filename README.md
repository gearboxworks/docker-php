...
| -------------------- | ---------------------------------------- |
| default | /usr/local/bin/php (default command) |
...
* * *
**Note: This README was generated by `JsonToConfig` - Created on 2020-05-24T22:27:49+1000, using template:README.md.tmpl and json:gearbox.json**
