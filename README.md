...
`./php-fpm -flag1 variable1 variable2 variable3`
...
The **php** [Gearbox](https://github.com/gearboxworks/) container has the following **10** available commands:
...
* * *
**Note: This README was generated by `JsonToConfig` - Created on 2020-05-24T22:19:43+1000, using template:README.md.tmpl and json:gearbox.json**
