...
Create, and start version **5.3.29** of the **php** [Gearbox](https://github.com/gearboxworks/) container and run a shell with commands.

**./bin/launch shell php:5.3.29 ls -l**

```
me@home:~ % ./bin/launch shell php:5.3.29 ls -l
Gearbox: Gear 'php:5.3.29' already started.
total 60
...
**./bin/launch shell php:5.3.29 ps -eaf**

```
me@home:~ % ./bin/launch shell php:5.3.29 ps -eaf
Gearbox: Gear 'php:5.3.29' already started.
...
+----------+----------------------------------+-------+--------+
| graphics | gearboxworks/php:5.3.29  |       |  40 MB |
+----------+----------------------------------+-------+--------+
...
+---------------------+----------+---------+----------------------------------+-------+----------+---------------+--------+--------+
| php-5.3.29  | graphics | created | gearboxworks/php:5.3.29  |       |          | (gearboxnet)  |        |  40 MB |
|                     |          |         |                                  |       |          |               |        |        |
+---------------------+----------+---------+----------------------------------+-------+----------+---------------+--------+--------+
...
`./bin/launch run php:5.3.29 -flag1 -flag2 variable1 variable2 variable3`

`./phar -flag1 -flag2`

`./php`

`./pear -flag1 variable1 variable2 variable3`
...
* * *
**Note: This README was generated by `JsonToConfig` - Created on 2020-05-25T12:59:47+1000, using template:README.md.tmpl and json:gearbox.json**
